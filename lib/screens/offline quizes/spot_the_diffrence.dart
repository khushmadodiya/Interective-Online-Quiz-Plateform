...
import 'package:quiz_platform/Widgets/spot_card_for_online_images.dart';
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddNewimage(title: 'Add image for spotting', collname: 'spotImg',)));
        },
